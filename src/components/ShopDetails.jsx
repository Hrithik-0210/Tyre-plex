  ...
  return (
    <div className="shop-Info-container p-2 shadow-lg  mt-2 ">
      <div className="top-box flex flex-col md:flex-row w-full  justify-between ">
        <div className="leftBox-shop-Details-container lg:w-[60%]">
          <div className="shop-name flex gap-2">
            <h2 className="text-base font-semibold lg:text-base xl:text-lg font-ubuntu my-2">
              SHREE HEMKUNT TYRES AND SERVICES
            </h2>
            <span className="text-green-500 flex my-2">
              <MdOutlineVerifiedUser />
              <p className="text-[11px] ">Verified</p>
            </span>
          </div>
          ...
          <div className="directin-button my-4">
            <button className=" flex justify-center items-center gap-2 bg-transparent hover:bg-red-500 text-red-500 font-medium hover:text-white py-2 px-6 lg:px-10 border border-red-500 hover:border-transparent rounded transition ease-in-out delay-150  duration-100">
